...
local UserName = (data.username_ or "Source_lIM")
...
usertext = '\n◈︙العضو » ['..result.title_..'](t.me/'..(username or 'Source_lIM')..')'
status  = '\n◈︙تم ترقيته مطور'
...
usertext = '\n◈︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_lIM')..')'
status  = '\n◈︙تم ترقيته مطور'
...
if lIM1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'◈︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_lIM')..') \n◈︙'..lIM1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"◈︙العضو : {["..data.first_name_.."](T.ME/Source_lIM)}\n◈︙["..lIM_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'◈︙من » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_lIM')..') \n◈︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'◈︙من » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Source_lIM')..') \n◈︙تـم قفـل التاك بالكتم ')
end,nil)   
...
local TextE = "\n↫ ┄┄┄┄┄┄┄┄┄┄┄┄ ↬\n◈︙علامة تعني { ✓ } ملف مفعل\n◈︙علامة تعني { ✘ } ملف معطل\n◈︙قناة سورس ليم ↓\n".."◈︙[اضغط هنا لدخول](t.me/Source_lIM) \n"
local NumFile = 0
...
local UserName = (b.username_ or "Source_lIM")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n◈︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_lIM')..')'
status  = '\n◈︙تم نزلته من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n◈︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n◈︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_lIM')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n◈︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Source_lIM')..')'..'\n◈︙تم رفعته '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_lIM')..')'
local iduser = result.sender_user_id_
...
DeleteMessage(Chat_id,{[0] = Msg_id})    
require("socket.http").request("https://black-source.tk/blackTeAM/searchinbot.php?url="..kkp[1].."&token="..token.."&chat="..data.chat_id_.."&rep="..kkp[2].."&type=mp3")
elseif Text and Text:match('mp4/(.*)/@m(%d+)') then
local kkp = {string.match(Text,"^mp4/(.*)/@m(%d+)$")}
DeleteMessage(Chat_id,{[0] = Msg_id})    
require("socket.http").request("https://black-source.tk/blackTeAM/searchinbot.php?url="..kkp[1].."&token="..token.."&chat="..data.chat_id_.."&rep="..kkp[2].."&type=mp4")
end 
